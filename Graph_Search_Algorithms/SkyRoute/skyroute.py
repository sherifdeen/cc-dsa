...
stations_under_construction = ['Olympic Village', 'Lansdowne']
...
for station, neighbors in active_stations.items():
  print(station + "--" + str(neighbors))

  
skyroute()
#print(vc_landmarks.keys())
#print(set_start_and_end(None, None))
#print(get_route('Science World', 'Marine Building'))
